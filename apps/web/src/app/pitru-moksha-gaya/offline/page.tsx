...
const steps = [
  ...
  ['Confirm Your Journey', 'Coordinate the Religious Partner, schedule, travel and local arrangements.'],
...
export default function OfflinePage() {
  return <FuturePathPage eyebrow="OFFLINE ANCESTRAL SERVICES" title="In-Person PitruMoksha Gaya Services" description="The complete Offline service page is being prepared. Families may raise an inquiry now for Religious Partner coordination, ritual planning and local assistance in Gaya." breadcrumb={[{label:'Connect Hub Co.',href:'/'},{label:'PitruMoksha Gaya',href:PITRU_MOKSHA_GAYA_ROUTE},{label:'Offline'}]} heroLogo={{src:'/images/hero/PitruMoksha_Gaya_Logo_Master.png',alt:'PitruMoksha Gaya official logo'}}>
    <section className={styles.overview} id="pitra-aatma-shanti" aria-labelledby="offline-journey-title">
      <div><p>THE IN-PERSON JOURNEY</p><h2 id="offline-journey-title">Guiding Families on the Path of Ancestral Peace and Moksha.</h2><p>PitruMoksha Gaya provides end-to-end ancestral ritual guidance and local coordination for families travelling to Gaya, delivered through verified Religious Partners with respectful assistance from preparation through completion.</p></div>
