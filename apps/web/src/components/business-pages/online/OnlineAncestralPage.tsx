...
const prompts: readonly AssistantPrompt[] = [
  { id: 'virtual-shraddh', label: 'What is Virtual Shraddh?', response: 'Virtual Shraddh is a remotely coordinated ancestral ritual in which a verified Religious Partner performs the agreed ritual and eligible family members participate through guided live arrangements.' },
  { id: 'another-country', label: 'Can I participate from another country?', response: 'Yes. Participation may be coordinated across countries and time zones where the ritual format and practical arrangements are suitable.' },
  { id: 'online-pind-daan', label: 'How does online Pind Daan participation work?', response: 'The authorised team confirms required details, timing, Religious Partner coordination and the approved method of family participation before booking.' },
  { id: 'family-together', label: 'Can my family join together online?', response: 'Eligible family members may join the arranged live session together when connection and participation details are confirmed in advance.' },
  { id: 'remote-sankalp', label: 'How is Sankalp guided remotely?', response: 'The Religious Partner guides the family through the required names, Gotra, intention and Sankalp steps during the scheduled participation.' },
  { id: 'ancestor-details', label: 'What ancestor details are required?', response: 'Requirements may include ancestor names, Gotra, family relationship, relevant dates and the ritual purpose. The final list is confirmed during guidance.' },
  { id: 'documentation', label: 'Will I receive photos or videos?', response: 'Available photographs, videos or supporting documentation are confirmed transparently as part of the selected service plan.' },
  { id: 'begin', label: 'How do I begin?', response: 'Raise an inquiry with your location, preferred date, family details and the online service you are considering.' },
];
const faqs = [
...
export function OnlineAncestralPage() {
  return <BusinessPageFrame breadcrumb={[{ label: 'Connect Hub Co.', href: '/' }, { label: 'PitruMoksha Gaya', href: PITRU_MOKSHA_GAYA_ROUTE }, { label: 'Online' }]} className={styles.onlinePage}>
    ...
    <section className={`${styles.section} ${styles.aiSection}`}><div><p>GUIDED ANSWERS</p><h2>GenZ Online Ritual AI</h2><p>Ask about online participation, Virtual Shraddh, required details, scheduling and documentation.</p></div><HeroAssistantPanel standalone slide={{id:'pitru-moksha-online',title:'Online Ancestral Services',assistantTitle:'GenZ Online Ritual AI',assistantSubtitle:'Your Online Ritual Assistant',assistantIntro:'Ask about online participation, Virtual Shraddh, required details, scheduling and documentation.',assistantPrompts:prompts,assistantPlaceholder:'Ask about online participation...',defaultGuidance:'Select a question or enter your query for clear, approved guidance about online ancestral services and the next inquiry step.'}} /></section>
