...
const assistantPrompts: readonly AssistantPrompt[] = [
  {
    id: 'partner-eligibility',
    label: 'Who can apply to join the Religious Partner Network?',
    response: 'Qualified Pandits, Purohits, Pandas, Acharyas, Vaidik Scholars, and ritual specialists with verified background credentials and traditional experience.',
  },
  {
    id: 'registration-process',
    label: 'How does the partner registration process work?',
    response: 'Submit your registration details, complete background and credential verification, undergo profile setup, and begin receiving verified inquiries.',
  },
  {
    id: 'services-offered',
    label: 'Which services can I offer as a partner?',
    response: 'Approved partners may offer services matching their verified knowledge, location, language, and operational capability—such as Pind Daan, Havan, Puja, or Vahi Records guidance.',
  },
  {
    id: 'nri-customers',
    label: 'Can I serve NRI customers through the network?',
    response: 'Yes. Eligible partners support NRI families through approved online live-stream or coordinated in-person service formats.',
  },
];
      ...
      <section className={styles.section} aria-labelledby="ai-rpn-title">
        <HeroAssistantPanel
          ...
          slide={{
            ...
            defaultGuidance: 'Select an approved question or enter your query for clear, verified guidance regarding partner registration and onboarding standards.',
          }}
        />
      </section>
