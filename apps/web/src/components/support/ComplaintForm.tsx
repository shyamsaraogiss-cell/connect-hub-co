      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <label className={label}>
          ...
          <select className={field} required value={referenceType} onChange={(event) => setReferenceType(event.target.value)}>
            ...
            <option>Partner Registration ID</option>
