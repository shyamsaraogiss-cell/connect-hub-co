...
const workflowCopy = {
  complaint: {
    ...
    categories: [["service-quality", "Service Quality"], ["travel-logistics", "Travel or Logistics"], ["partner-conduct", "Religious Partner or Staff Conduct"], ["billing-scope", "Billing or Service Scope"], ["other", "Other"]],
  ...
  "founder-support": {
    ...
    categories: [["unresolved-issue", "Unresolved Issue"], ["sensitive-matter", "Sensitive Matter"], ["partner-concern", "Religious Partner Concern"], ["service-concern", "Service Concern"], ["other", "Other"]],
